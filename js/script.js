...
// at length below
var congressionalPromise = $.getJSON('https://congress.api.sunlightfoundation.com/legislators?apikey=721e2620a76a4a4d93562fa154f88811')
...
var handleData = function(apiResponse) {
    ...
    for (var i = 0; i < legArray.length; i ++) {
        ...
        htmlString += '<li class="stateName">state:' + legislatorObject.state_name + '</li>' 
        htmlString += '<li class="firstName">name:' + legislatorObject.first_name + '</li>'
        htmlString += '<li class="email">email:' + legislatorObject.oc_email + '</li>' 
